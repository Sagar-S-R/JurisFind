...
class LegalCaseSearcher:
    ...
    def _load_from_local(self):
        ...
        store_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "data", "faiss_store")
    ...
    def get_case_details(self, filename):
        ...
        pdf_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "data", "pdfs", filename)
